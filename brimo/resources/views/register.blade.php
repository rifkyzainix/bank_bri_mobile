            ...
            <form method="POST" action="{{ route('register.store') }}">
                ...
                <div class="row justify-content-center" style="background-color: #fff;padding-bottom: 10%;">
                    <div  class="col-lg-6 col-md-8 col-sm-12 px-3">
                        ...
                        <a class="d-flex justify-content-end" href="{{ route('login.index') }}">Login</a>
                    </div>
                </div>
                <div class="row" style="background-color: #fff;">
                    <div class="col-12">
                        <button type="submit" class="btn w-100 text-white py-2" style="background-color: #1f8fe5;margin-top: 10%;">Register</button>
                    </div>
                </div>
            </form>
        </div>
